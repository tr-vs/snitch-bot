...
exports.InteractionHandlerFilters = new Map([
    ["BUTTON" /* Button */, (interaction) => interaction.isButton()],
    ["SELECT_MENU" /* SelectMenu */, (interaction) => interaction.isSelectMenu()],
    ["MESSAGE_COMPONENT" /* MessageComponent */, (interaction) => interaction.isMessageComponent()],
    ["AUTOCOMPLETE" /* Autocomplete */, (Interaction) => Interaction.isAutocomplete()]
]);
